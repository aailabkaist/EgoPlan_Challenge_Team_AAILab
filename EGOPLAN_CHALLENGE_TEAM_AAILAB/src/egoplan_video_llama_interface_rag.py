...
def build(config_path = "src/video_llama/eval_configs/egoplan_video_llama_eval.yaml", model_ver=None, epoch=None):
    if model_ver is not None:
        config_path = f'src/video_llama/eval_configs/egoplan_video_llama_eval_{model_ver}.yaml'
