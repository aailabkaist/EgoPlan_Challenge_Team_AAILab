...
# Fixed Setting
MODEL_NAME="egoplan_video_llama_add_narr_bh"
PROJECT_ROOT="/home/aailab/data2/kasong13/EgoPlan-challenge/"
...
CUDA_VISIBLE_DEVICES=${DEVICE} nohup python3 -u eval_multiple_choice_test_rag.py \
--model ${MODEL_NAME} \
...
--rag_version ${VERSION} \
--epoch ${EPOCH} \
> logs_test/EPOCH_${EPOCH}_RAG_ver_${VERSION}_test_multiple_choice_${MODEL_NAME}_${BASE_MODEL}_${TRAINING_DATASET}_${EVALUATION_DATASET}_${SPECIFIC_REMARK}.log 2>&1 & 
# full log file 저장용, save_name은 accuracy.txt 파일 생성에 쓰임