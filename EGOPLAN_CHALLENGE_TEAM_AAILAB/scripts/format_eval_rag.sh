...
CUDA_VISIBLE_DEVICES=${DEVICE} nohup python3 -u eval_multiple_choice_available_add_narr_bh_rag_v1.py \
--model ${MODEL_NAME} \
...
> logs_eval/eval_multiple_choice_${MODEL_NAME}_${BASE_MODEL}_${TRAINING_DATASET}_${EVALUATION_DATASET}_${SPECIFIC_REMARK}.log 2>&1 & # full log file 저장용, save_name은 accuracy.txt 파일 생성에 쓰임